...
| 3.7 | Reviews & Ratings Display | SCRUM-55 | As a user, I want to read reviews and ratings from other attendees, so that I can decide if it's worth attending. | ✅ | Overall rating with stars, default 3 most recent reviews, load more functionality, user avatars and review cards |